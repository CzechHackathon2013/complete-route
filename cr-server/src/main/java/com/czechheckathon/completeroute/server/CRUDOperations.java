...
public class CRUDOperations {
    ...
    private void insertBanking() {
        BasicDBObject banking = new BasicDBObject("_id", "banking").append("name", "Bankovnictvi").append("icon", "banking");
    ...
    private void insertTelco() {
        ...
        BasicDBObject routeTelefonica1 = new BasicDBObject("keypad", 1).append("description","Faktury, platby a posledni vyuctovani");
        ...
        BasicDBObject routeTelefonica13 = new BasicDBObject("keypad", 3).append("description","Posledni vyuctovani").append("routes", Collections.emptyList());;
        routeTelefonica1.append("routes", Arrays.asList(routeTelefonica11, routeTelefonica12, routeTelefonica13));
        BasicDBObject routeTelefonica2 = new BasicDBObject("keypad", 2).append("description","Nastaveni stavajicich sluzeb, a roaming");
        BasicDBObject routeTelefonica21 = new BasicDBObject("keypad", 1).append("description","Nastaveni stavajicich sluzeb").append("routes", Collections.emptyList());;
        ...
        BasicDBObject routeTelefonica3 = new BasicDBObject("keypad", 3).append("description","Aktivace tarifu a sluzeb");
        ...
        BasicDBObject routeTelefonica32 = new BasicDBObject("keypad", 2).append("description","Aktivace nové sluzby").append("routes", Collections.emptyList());;
        routeTelefonica3.append("routes", Arrays.asList(routeTelefonica31, routeTelefonica32));
        BasicDBObject routeTelefonica4 = new BasicDBObject("keypad", 4).append("description","Nahlaseni poruchy").append("routes", Collections.emptyList());;
        BasicDBObject routeTelefonica5 = new BasicDBObject("keypad", 5).append("description","Vypoved sluzby").append("routes", Collections.emptyList());;
        ...
        BasicDBObject centropol = new BasicDBObject("name", "Centropol").append("description", "Centropol - virtualni operator")
    ...
    private void insertServices() {
        BasicDBObject services = new BasicDBObject("_id", "services").append("name", "Sluzby").append("icon", "services");
        services.append("companies", Collections.emptyList());
        collection.insert(services);
    }

    private void insertInsurance() {
        BasicDBObject insurance = new BasicDBObject("_id", "insurance").append("name", "Pojisteni").append("icon", "insurance");
        insurance.append("companies", Collections.emptyList());
        collection.insert(insurance);
    }

    private void insertGovernment() {
        BasicDBObject government = new BasicDBObject("_id", "government").append("name", "Statni sprava").append("icon", "government");
